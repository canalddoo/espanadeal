export const PRODUCTS_DATA = [
  // ==========================================
  // DISPOSITIVOS ELECTRÓNICOS & VIDEOJUEGOS (25 Productos)
  // ==========================================
  { id: 1, name: "iPhone 11 (Reacondicionado)", price: 99.99, category: "Dispositivos electrónicos", image: "https://c0.lestechnophiles.com/www.frandroid.com/wp-content/uploads/2019/08/apple-iphone-11-frandroid-2019.png?webp=1&resize=580,580&key=fcb2a39b" },
  { id: 2, name: "iPhone 12 (Reacondicionado)", price: 129.99, category: "Dispositivos electrónicos", image: "https://c0.lestechnophiles.com/images.frandroid.com/wp-content/uploads/2020/10/iphone-12-frandroid-2020-768x768.png?webp=1&resize=580,580&key=1b5d60de" },
  { id: 3, name: "iPhone 12 Pro (Reacondicionado)", price: 169.99, category: "Dispositivos electrónicos", image: "https://c0.lestechnophiles.com/images.frandroid.com/wp-content/uploads/2020/10/iphone-12-max-frandroid-2020-768x768.png?webp=1&resize=580,580&key=85d800ac" },
  { id: 4, name: "iPhone 13 (Reacondicionado)", price: 249.99, category: "Dispositivos electrónicos", image: "https://c0.lestechnophiles.com/images.frandroid.com/wp-content/uploads/2021/09/apple-iphone-13-frandroid-2021-768x768.png?webp=1&resize=580,580&key=a6b052d7" },
  { id: 5, name: "iPhone 13 Pro Max (Reacondicionado)", price: 279.99, category: "Dispositivos electrónicos", image: "https://c0.lestechnophiles.com/images.frandroid.com/wp-content/uploads/2021/09/apple-iphone-13-pro-max-frandroid-2021-768x768.png?webp=1&key=33af98cc" },
  { id: 7, name: "iPhone 14 Pro (Reacondicionado)", price: 359.99, category: "Dispositivos electrónicos", image: "https://c0.lestechnophiles.com/images.frandroid.com/wp-content/uploads/2022/09/iphone-14-pro-max-officiel-frandroid-2022-768x768.png?webp=1&key=1e26da76" },
  { id: 8, name: "iPhone 15 (Reacondicionado)", price: 399.99, category: "Dispositivos electrónicos", image: "https://c0.lestechnophiles.com/images.frandroid.com/wp-content/uploads/2023/09/iphone-15-768x768.png?webp=1&key=62513184" },
  { id: 9, name: "iPhone 15 Pro Max (Reacondicionado)", price: 449.99, category: "Dispositivos electrónicos", image: "https://c0.lestechnophiles.com/images.frandroid.com/wp-content/uploads/2023/09/iphone-15-pro-max-768x768.png?webp=1&key=6d7ed62f" },
  { id: 10, name: "Apple iPhone 16 (128 GB) (Reacondicionado) - Cian + Funda Transparente con MagSafe", price: 589.99, category: "Dispositivos electrónicos", image: "/img/iPhone16.jpg" },
  { id: 11, name: "iPhone 16 Pro Max (Reacondicionado)", price: 619.99, category: "Dispositivos electrónicos", image: "https://c0.lestechnophiles.com/images.frandroid.com/wp-content/uploads/2024/08/apple-iphone-16-pro-max-frandroid-2024-hd-768x768.png?webp=1&key=ce4d50e3" },
  ...
  { id: 40, name: "SHOKZ OpenFit Pro Open Ear Auriculares Inalámbricos Negro", price: 229, category: "Dispositivos electrónicos", image: "/img/SHOKZOpenFitProOpen.jpg" },
  { id: 41, name: "Realme Buds Clip", price: 54.99, category: "Dispositivos electrónicos", image: "https://c0.lestechnophiles.com/images.frandroid.com/wp-content/uploads/2025/12/realme-buds-clip-frandroid-2025-300x300.png?webp=1&key=4be0b994" },
  ...
  { id: 62, name: "DJI Osmo Pocket 3 + Transmisor Mic Mini (Negro Obsidiana), cámara para vlogging, micrófono inalámbrico", price: 349, category: "Dispositivos electrónicos", image: "/img/DJIOsmoPocket3.jpg" },
  ...
  { id: 21, name: "Puma Smash V2 L Zapatillas Unisex", price: 22.99, category: "Deporte / Fitness", image: "/img/PumaSmashV2LBasketsMixte.jpg" },
  { id: 22, name: "Adidas Unisex Zapatillas VS Pace 2.0", price: 27.99, category: "Deporte / Fitness", image: "/img/adidasUnisexChaussure.jpg" },
  ...
  { id: 51, name: "UrbanLuxe Colchoneta de Gimnasia Inflable Air Tumble Track para Volteretas y Acrobacias", price: 69.99, category: "Deporte / Fitness", image: "/img/TapisdeGymnastique.jpg" },
  ...
  // ==========================================
  // HOGAR & COCINA (6 Productos)
  // ==========================================
  { id: 36, name: "Ninja Foodi FlexDrawer Freidora de Aire, Dual Zone Con Separador Extraíble", price: 119, category: "Cocina", image: "/img/NinjaFoodiFlexDrawerAir.jpg" },
  { id: 37, name: "ECOVACS T50 Omni GEN2 Robot Aspirador con Estación, Potencia de 21000 Pa", price: 219, category: "Hogar", image: "/img/ECOVACST50OmniGEN2Aspirateur.jpg" },
  { id: 38, name: "SNDOAS Placa de Gas de 4 Fuegos Cristal Blanco, Placa de Gas Integrable", price: 99, category: "Cocina", image: "/img/SNDOASPlaque.jpg" },
